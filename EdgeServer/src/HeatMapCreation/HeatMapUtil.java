...
public class HeatMapUtil {
    static public HeatMap heatMapRSSI;
    static public HeatMap heatMapThroughput;
    private enum Limits {
    ...
    public static void createHeatMap() throws Exception {
        ...
        //produce heat maps
        heatMapRSSI=new HeatMap(Limits.MIN_LAT.value(),Limits.MAX_LAT.value(),Limits.MIN_LONG.value(),Limits.MAX_LONG.value());
        heatMapThroughput=new HeatMap(Limits.MIN_LAT.value(),Limits.MAX_LAT.value(),Limits.MIN_LONG.value(),Limits.MAX_LONG.value());
